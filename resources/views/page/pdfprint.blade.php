...
<body style="font-family: sans-serif" onload="window.print()">
    ...
    <table width="50%" border="0" style="margin-left:3%;margin-right:2%;float:left">
        ...
        <tr>
            <td colspan="3">Akses<a style="font: blue; text-decoration: none;" href="http://127.0.0.1:8000/login">
                    http://127.0.0.1:8000/login</a>, login gunakan</td>
        </tr>
        <tr>
    ...
    <table width="37%" border="0">
        ...
        <tr>
            <td>Pembayaran uang seleksi sebesar Rp. 200.
                @if ($pdf['id'] > 0 && $pdf['id'] < 10)
                    00{{ $pdf['id'] }}
                @elseif($pdf['id'] >= 10 && $pdf['id'] < 100)
                    0{{ $pdf['id'] }}
                @endif melalui transfer bank:
            </td>
        </tr>
        <tr>
            <td>
